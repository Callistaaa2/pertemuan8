  ...
  <header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="<?= base_url('/wildan_data'); ?>">DATA DIRI</a></li>
    ...
    <h1 class="text-center">Data diri mahasiswa</h1>
    <div class="container">
      <div class="row">
        <div class="col-5">
          <img src="<?= base_url('image/profil.jpg') ?>" width="25%" alt="foto-profile">
        </div>
        <div class="col-7">
          Nama: Muhammad Faqih Wildan <br>
          NIM: 23.240.0035 <br>
          Kelas: 3P41 <br>
          PROGDI: TI <br>
        </div>
